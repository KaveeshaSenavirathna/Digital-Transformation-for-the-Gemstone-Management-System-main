  ...
  return (
    <div className="main-layout-container">
      ...
      <nav className="sidebar-nav">
        ...
        <div className="view-toggle-buttons-sidebar">
          <button
        ...
        <ul className="nav-links-list">
          {currentView === "detailed" && (
            <>
              <li><a href="#preform" onClick={() => setCurrentView("detailed")}>Preform</a></li>
              <li><a href="#preform-proceed" onClick={() => setCurrentView("detailed")}>Preform Proceed</a></li>
              <li><a href="#calibrate" onClick={() => setCurrentView("detailed")}>Calibrate</a></li>
              <li><a href="#calibrate-proceed" onClick={() => setCurrentView("detailed")}>Calibrate Proceed</a></li>
              <li><a href="#dop" onClick={() => setCurrentView("detailed")}>DOP</a></li>
              <li><a href="#dop-proceed" onClick={() => setCurrentView("detailed")}>DOP Proceed</a></li>
              <li><a href="#cut-&-polish" onClick={() => setCurrentView("detailed")}>Cut & Polish</a></li>
              <li><a href="#cut-&-polish-proceed" onClick={() => setCurrentView("detailed")}>Cut & Polish Proceed</a></li>
              <li><a href="#final-outcomes" onClick={() => setCurrentView("detailed")}>Final Outcomes</a></li>
            </>
          )}
        </ul>
      </nav>
